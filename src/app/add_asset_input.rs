...
use crate::app::{asset_reference::AssetReference, asset_reference_type::AssetReferenceType};
...
impl Default for AddAssetInput {
    fn default() -> Self {
        Self {
            name: String::new(),
            reference: AssetReference { r#type: AssetReferenceType::Isin, value: String::new() },
